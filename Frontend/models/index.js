...
// Artista N - N Genero
artista.belongsToMany(genero, { through: artistaGenero, as: 'generos', foreignKey: 'idArtista' });
genero.belongsToMany(artista, { through: artistaGenero, as: 'artistas', foreignKey: 'idGenero' });
